...
// week Lucas: 64da35b47a1247b56b3042b4
  ...
  try {
    ...
    // const classProfessorMondayAt9 = await Class.findById(
    //   calendarDetails.monday.at9[0]._id
    // ).populate("teacher");
    // let professorMondayAt9 = classProfessorMondayAt9.teacher;
    // const classProfessorMondayAt12 = await Class.findById(
    //   calendarDetails.monday.at12[0]._id
    // ).populate("teacher");
    // let professorMondayAt12 = classProfessorMondayAt12.teacher;
    // const classProfessorMondayAt15 = await Class.findById(
    //   calendarDetails.monday.at15[0]._id
    // ).populate("teacher");
    // let professorMondayAt15 = classProfessorMondayAt15.teacher;
    // const classProfessorMondayAt18 = await Class.findById(
    //   calendarDetails.monday.at18[0]._id
    // ).populate("teacher");
    // let professorMondayAt18 = classProfessorMondayAt18.teacher;

    // MARTES

    // const classProfessorTuesdayAt9 = await Class.findById(
    //   calendarDetails.tuesday.at9[0]._id
    // ).populate("teacher");
    // let professorTuesdayAt9 = classProfessorTuesdayAt9.teacher;
    // const classProfessorTuesdayAt12 = await Class.findById(
    //   calendarDetails.tuesday.at12[0]._id
    // ).populate("teacher");
    // let professorTuesdayAt12 = classProfessorTuesdayAt12.teacher;
    // const classProfessorTuesdayAt15 = await Class.findById(
    //   calendarDetails.tuesday.at15[0]._id
    // ).populate("teacher");
    // let professorTuesdayAt15 = classProfessorTuesdayAt15.teacher;
    // const classProfessorTuesdayAt18 = await Class.findById(
    //   calendarDetails.tuesday.at18[0]._id
    // ).populate("teacher");
    // let professorTuesdayAt18 = classProfessorTuesdayAt18.teacher;

    // MIERCOLES

    // const classProfessorWednesdayAt9 = await Class.findById(
    //   calendarDetails.wednesday.at9[0]._id
    // ).populate("teacher");
    // let professorWednesdayAt9 = classProfessorWednesdayAt9.teacher;
    // const classProfessorWednesdayAt12 = await Class.findById(
    //   calendarDetails.wednesday.at12[0]._id
    // ).populate("teacher");
    // let professorWednesdayAt12 = classProfessorWednesdayAt12.teacher;
    // const classProfessorWednesdayAt15 = await Class.findById(
    //   calendarDetails.wednesday.at15[0]._id
    // ).populate("teacher");
    // let professorWednesdayAt15 = classProfessorWednesdayAt15.teacher;
    // const classProfessorWednesdayAt18 = await Class.findById(
    //   calendarDetails.wednesday.at18[0]._id
    // ).populate("teacher");
    // let professorWednesdayAt18 = classProfessorWednesdayAt18.teacher;

    // // JUEVES

    // const classProfessorThursdayAt9 = await Class.findById(
    //   calendarDetails.thursday.at9[0]._id
    // ).populate("teacher");
    // let professorThursdayAt9 = classProfessorThursdayAt9.teacher;
    // const classProfessorThursdayAt12 = await Class.findById(
    //   calendarDetails.thursday.at12[0]._id
    // ).populate("teacher");
    // let professorThursdayAt12 = classProfessorThursdayAt12.teacher;
    // const classProfessorThursdayAt15 = await Class.findById(
    //   calendarDetails.thursday.at15[0]._id
    // ).populate("teacher");
    // let professorThursdayAt15 = classProfessorThursdayAt15.teacher;
    // const classProfessorThursdayAt18 = await Class.findById(
    //   calendarDetails.thursday.at18[0]._id
    // ).populate("teacher");
    // let professorThursdayAt18 = classProfessorThursdayAt18.teacher;

    // // VIERNES

    // const classProfessorFridayAt9 = await Class.findById(
    //   calendarDetails.friday.at9[0]._id
    // ).populate("teacher");
    // let professorFridayAt9 = classProfessorFridayAt9.teacher;
    // const classProfessorFridayAt12 = await Class.findById(
    //   calendarDetails.friday.at12[0]._id
    // ).populate("teacher");
    // let professorFridayAt12 = classProfessorFridayAt12.teacher;
    // const classProfessorFridayAt15 = await Class.findById(
    //   calendarDetails.friday.at15[0]._id
    // ).populate("teacher");
    // let professorFridayAt15 = classProfessorFridayAt15.teacher;
    // const classProfessorFridayAt18 = await Class.findById(
    //   calendarDetails.friday.at18[0]._id
    // ).populate("teacher");
